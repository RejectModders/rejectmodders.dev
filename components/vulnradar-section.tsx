...
export function VulnRadarSection() {
  return (
    <section id="vulnradar" className="relative py-24 md:py-32" style={{ overflow: "clip" }}>
      {/* Ambient red glow */}
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="mt-8 grid gap-3 sm:grid-cols-2">
              {features.map((f) => (
                <div key={f.label} className="card-hover flex items-start gap-3 rounded-xl border border-border bg-card p-4">
